...
public final class Sort2
{
    ...
    public static void Random_StringGenerator(String[] a, int length)
    {
    		RandomStringGenerator ran = new RandomStringGenerator();
    		for (int i = 0; i < a.length; i++)
    		{
    			a[i] = ran.RandomString(length);
    		}
    }
    
    public static long Compute_MergeSort(String[] a)
    {
    		long time_start;
    ...
    public static long Compute_QuickSort(String[] a)
    {
    		long time_start;
		time_start = System.nanoTime();
		Sort2.quicksort(a);
    ...
    public static long Compute_HeapSort(String[] a)
    {
    		long time_start;
		time_start = System.nanoTime();
		Sort2.heapsort(a);
    ...
    public static long Compute_DualPivotSort(String[] a)
    {
    		long time_start;
		time_start = System.nanoTime();
		Arrays.sort(a);
    ...
    public static void Sort_Time(String[] a, int length)
    {
    		long total_time1 = 0; //MergeSort
    		long total_time2 = 0; //QuickSort
    		long total_time3 = 0; //HeapSort
    		long total_time4 = 0; //DualPivotSort
    		...
    		for (int i = 0; i < 10; i++)
    		{
    			Random_StringGenerator(a, length);
    			a1 = a.clone();
    			a2 = a.clone();
    			a3 = a.clone();
    			a4 = a.clone();
    			
    			total_time1 += Compute_MergeSort(a1);
    			total_time2 += Compute_QuickSort(a2);
    			total_time3 += Compute_HeapSort(a3);
    			total_time4 += Compute_DualPivotSort(a4);
