...
//        System.out.println( "Finished checksort" );
    ...
    //a. Create 100,000 random keys (of type long)
    public static void Random_LongGenerator(Long[] a)
    {
    ...
    public static long Compute_MergeSort(Long[] a)
    {
    		long time_start;
    		Random_LongGenerator(a);
    		time_start = System.nanoTime();
    		Sort.mergeSort(a);
    		return System.nanoTime() - time_start;
    }
    
    public static long Compute_QuickSort(Long[] a)
    {
    		long time_start;
       	Random_LongGenerator(a);
		time_start = System.nanoTime();
    ...
    public static long Compute_HeapSort(Long[] a)
    {
    		long time_start;
    		Random_LongGenerator(a);
		time_start = System.nanoTime();
    ...
    public static long Compute_DualPivotSort(Long[] a)
    {
    		long time_start;
    		Random_LongGenerator(a);
		time_start = System.nanoTime();
    ...
    public static void main( String [ ] args )
    {
    		...
    		//Compute time for MergeSort
    		for (int i = 0; i <= 100; i++)
    		{
    			total_time += Compute_MergeSort(a);
    			checkSort(a);
    		}
    		System.out.println("The MergeSort time is " + total_time / 100);
    		
    		total_time = 0;

    		//Compute time for QuickSort
    		total_time = 0;
    		for (int i = 0; i <= 100; i++)
    		{
    			total_time += Compute_QuickSort(a);
    			checkSort(a);
    		}
    		System.out.println("The QuickSort time is " + total_time / 100);
    	
    		//Compute time for HeapSort
    		total_time = 0;
    		for (int i = 0; i <= 100; i++)
    		{
    			total_time += Compute_HeapSort(a);
    			checkSort(a);
    		}
    		System.out.println("The HeapSort time is " + total_time / 100);
    		
      	//Compute time for DualPivotSort
    		total_time = 0;
    		for (int i = 0; i <= 100; i++)
    		{
    			total_time += Compute_DualPivotSort(a);
    			checkSort(a);
    		}
    		System.out.println("The DualPivotSort time is " + total_time / 100);
